            ...
            <ul className="flex items-center space-x-8 text-gray-300">
              <li>
                <button
                  ...
                  className=" hover:text-emerald-600 px-3 py-2 rounded-md text-sm font-medium focus:outline-none focus:text-emerald-600 "
          ...
          {userType ? (
            <div className="hidden md:flex items-center">
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div
                    className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-slate-700 ring-1 text-gray-300 z-50"
                    role="menu"
                  ...
                  >
                    <div className="py-1" role="none">
                      <button
                        ...
                        className="flex items-center w-full text-left px-4 py-2 text-sm hover:bg-slate-600"
                        role="menuitem"
                      >
                        Dashboard
                      </button>
              ...
              {userType ? (
                <div className="pt-4 pb-2 border-t border-gray-200">
                  <div className="flex flex-col space-y-2">
                    <button
                      onClick={navigateToDashboard}
                      className="hover:bg-emerald-100 text-emerald-600 hover:text-emerald-700 px-3 py-2 rounded-md text-base font-medium text-left"
                    >
                      Dashboard
                    </button>
                    <button
                ...
                <div className="pt-4 pb-2 border-t border-gray-200">
                  <div className="flex flex-col space-y-2">
                    <Link to="/login" className="hover:bg-emerald-100 text-emerald-600 hover:text-emerald-700 px-3 py-2 rounded-md text-base font-medium text-left">
                      Sign In
                    </Link>
