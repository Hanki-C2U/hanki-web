...
export default function Header() {
  ...
  return (
    <header className={`bg-white sticky top-0 z-50 transition-all duration-200`} style={{
          ...
          <nav className="hidden md:block" role="navigation" aria-label="Main navigation">
            <ul className="flex items-center space-x-8">
              <li>
                  ...
                  className="text-gray-700 hover:text-emerald-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 focus:outline-none"
        ...
        {isMenuOpen && (
          <div className="md:hidden" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50 rounded-lg mb-4" role="menu">
              <button
                onClick={() => scrollToSection('who-its-for')}
                className="text-gray-700 hover:text-emerald-600 block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 w-full text-left focus:outline-none"
                role="menuitem"
                aria-label="Navigate to Who It's For section"
              >
                Who It's For
