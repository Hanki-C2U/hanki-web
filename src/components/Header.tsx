      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4 md:py-6">
          ...
          <div className="hidden md:flex items-center">
            <button type="button" onClick={openDemo} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:scale-105">
              Explore demo
            </button>
          </div>
          ...
          <div className="md:hidden" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-slate-700/50 rounded-lg mb-4 border border-slate-600" role="menu">
              ...
              <div className="pt-4 pb-2 border-t border-slate-600">
                <button type="button" onClick={openDemo} className="block w-full bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-2 rounded-md text-base font-medium text-center transition-colors">
                  Explore demo
                </button>
              </div>
            </div>
